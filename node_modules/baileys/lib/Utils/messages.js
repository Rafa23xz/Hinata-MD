...
const generateWAMessageContent = async (message, options) => {
    ...
    // Adicionar suporte a buttons e templates
    ...
    m = WAProto_1.proto.Message.fromObject(m);
...
const generateWAMessageFromContent = (jid, message, options) => {
    ...
    // Aplicar o patch para botões funcionarem
    message = patchMessageForMdIfRequired(message);
